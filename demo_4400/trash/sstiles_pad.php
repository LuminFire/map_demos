...
/**
 *
 * This script is based on the Stupid Simple Tile Maker which can
 * be found on GitHub: https://github.com/stuporglue/sstiles
 *
...
$t = new sstiles(__DIR__ . '/old_car.jpg',$zoom,$x,$y,'pad',__DIR__ . '/cache');
$t->sendTile();
